...
set genomeRtd $env(RT_TMP)/27A39B02C70.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {hdmi_text_controller_v1_0_AXI__GB6}]"
...
set genomeName [subst -nocommands -novariables {hdmi_text_controller_v1_0_AXI__GB6}]
